...
const errorMessages = {
  noAuth: {
    warning: 'WARNING: You haven\'t set an authentication code, this means anyone could post data to your server.',
    error: 'Authentication code not present, please add \'?auth=<your-auth-code-here>\' to the end of your url.'
  },
  incorrectAuth: 'Incorrect authentication code supplied.',
