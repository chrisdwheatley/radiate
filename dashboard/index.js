      ...
      <Dashboard>
        <Grid layout={layout}>
          ...
          <Cell name='local-data'>
            <Value title='Data can be fetched from JSON stored locally and updated via POST, for example the current temperature' file='weather.json' prop='temperature' frequency={10} suffix='°C' compare last-updated/>
          </Cell>
